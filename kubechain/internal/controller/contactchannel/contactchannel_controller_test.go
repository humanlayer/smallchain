...
var _ = Describe("ContactChannel Controller", func() {
	Context("When reconciling a resource", func() {
		...
		BeforeEach(func() {
			By("creating the custom resource for the Kind ContactChannel")
			err := k8sClient.Get(ctx, typeNamespacedName, contactchannel)
		...
		AfterEach(func() {
			...
			By("Cleanup the specific resource instance ContactChannel")
